## change the structure of conv model: conv + bn + activate
...
class DQNAgent:
    ...
    def update_epsilon(self):
        ...
        self.epsilon = self.epsilon * 1.00
...
if __name__ == '__main__':
    ...
    logfile = 'traffic_light_control_version2_6.txt'
    weightfile = 'traffic_light_control_version2_6/traffic_light_control_version2_'
